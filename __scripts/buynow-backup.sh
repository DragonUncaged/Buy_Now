...
PASSWORD="PASSWORD"
echo "Host: ${HOST}"
DATABASE_NAME="buynow"
echo "Database: ${DATABASE_NAME}"
time=$(date '+%d-%m-%Y_%H-%M-%S');
BACKUP="/home/aelassas/buynow/db/${DATABASE_NAME}-${time}.gz"
CDN="/home/aelassas/buynow/db/cdn-${time}.zip"
echo "Backup: ${BACKUP}"
BACKUP_LATEST="/home/aelassas/buynow/db/${DATABASE_NAME}.gz"
CDN_LATEST="/home/aelassas/buynow/db/cdn.zip"
_PWD=$PWD
